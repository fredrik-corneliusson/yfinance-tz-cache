...
class TickerBase:
    ...
    def get_income_stmt(self, proxy=None, as_dict=False, freq="yearly"):
        self._fundamentals.proxy = proxy
        data = self._fundamentals.financials.get_income(freq=freq, proxy=None)
        if as_dict:
            return data.to_dict()
        return data
    ...
    def get_balance_sheet(self, proxy=None, as_dict=False, freq="yearly"):
        self._fundamentals.proxy = proxy
        data = self._fundamentals.financials.get_balance_sheet(freq=freq, proxy=None)
        if as_dict:
            return data.to_dict()
        return data
    ...
    def get_cashflow(self, proxy=None, as_dict=False, freq="yearly"):
        self._fundamentals.proxy = proxy
        data = self._fundamentals.financials.get_cash_flow(freq=freq, proxy=None)
        if as_dict:
            return data.to_dict()
        return data
